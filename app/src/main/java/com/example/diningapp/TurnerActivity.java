...
import com.example.diningapp.databinding.ActivityTurnerBinding;
...
public class TurnerActivity extends AppCompatActivity {
    private ActivityTurnerBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityTurnerBinding.inflate(getLayoutInflater());
